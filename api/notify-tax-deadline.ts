...
import { NotifyVehiclesNearTaxDeadlineService } from "../src/job/notify-vehicles-near-tax-deadline";
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    logger.info("Starting notify-vehicles-near-tax-deadline API job");
    ...
    return res.status(200).json({
      success: true,
      message: "Tax deadline notification job completed successfully",
